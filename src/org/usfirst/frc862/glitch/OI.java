...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("ProcessVision", new ProcessVision());
        SmartDashboard.putData("VisionArcade", new VisionArcade());
        SmartDashboard.putData("VisionFollow", new VisionFollow());
        SmartDashboard.putData("ScanForCube", new ScanForCube());
